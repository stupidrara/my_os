...
LEDS    EQU     0x0ff1             ; 
VMODE   EQU     0x0ff2             ; 與色彩有關的資訊。表示顏色會使用到的位元數。
SCRNX   EQU     0x0ff4             ; X方向的解析度(screen x)
SCRNY   EQU     0x0ff6             ; Y方向的解析度(screen y)
VRAM    EQU     0x0ff8             ; Graphic buffer的起始位址
    
        ORG     0xc200
        MOV     AL, 0x13            ; VGA圖形、320x200x8bit彩色
        MOV     AH, 0x00
        INT     0x10                ; interrupt
